        ...
        async public Task<IActionResult> ForgetPassword([FromBody] User user)
        {
            ...
            if (existing_user != null)
            {
                await _emailService.SendEmailAsync(
                    existing_user.email,
                    "Reset Password",
                    $"Your reset password link is https://www.smartqrcodeandlogo.com/resetpassword"
                );
